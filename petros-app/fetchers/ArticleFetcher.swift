...
class ArticleFetcher {
    static func fetchFoundationNightArticles() -> [Article] {
        return [
            Article(
                title: "Foundation Night: October",
